...
const BodyTwo = () => {
  return (
    <div className="py-10">
      ...
      <div className="mx-[-83px] md:mx-auto gap-20 grid grid-cols-2 md:grid-cols-3  pl-48 md:pl-56  container py-10">
        <div className="w-48 md:pb-10 ">
          <img src={Logo1} alt="" />
          <p className="text-[14px] mt-10">SOCIAL MEDIA MARKETING</p>
          <p className="text-xs">
        ...
        <div className="w-48 md:pb-10">
          <img src={Logo2} alt="" />
          <p className="text-[14px] mt-10">Search Engine Optimisation</p>
          <p className="text-xs">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente,
            similique aut. Omnis recusandae praesen
          </p>
        ...
        <div className="w-48 md:pb-10">
          <img src={Logo3} alt="" />
          <p className="text-[14px] mt-10">Growth Hacking</p>
          <p className="text-xs">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente,
            similique aut. Omnis recusandae praesen
          </p>
        ...
        <div className="w-48 pt-2">
          <img src={Logo4} alt="" />
          <p className="text-[14px]">Branding</p>
          <p className="text-xs">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente,
            similique aut. Omnis recusandae praesen
          </p>
